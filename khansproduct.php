...
<div class="row row-cols-1 row-cols-md-5 g-4 mt-5 ml-5">
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '
    <form class="card mx-auto col-md-2 col-10 mt-5">
    <div>
        <img class="mx-auto img-thumbnail"
           ...
           <div class="card-body text-center mx-auto">
             <div class="cvp">
                ...
                <input type="hidden" name="item_price" value="taka">
            </div>
        </div>
    </div>
    </form class="card mx-auto col-md-2 col-10 mt-5">';
